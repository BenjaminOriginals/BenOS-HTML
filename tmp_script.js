...
async function runBoot(){
  ...
  document.querySelectorAll("a[data-benbrowser]").forEach(a=>{a.addEventListener("click",e=>{e.preventDefault();const url=a.getAttribute("data-benbrowser");window.parent.postMessage({__benos:true,type:"browser-navigate",url},"*");});});
