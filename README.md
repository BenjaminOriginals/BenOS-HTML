...
| BenStudio | Native HTML, CSS, and JavaScript editor - make your own apps to install right in BenOS HTML Edition! With BenStudio, as long as you can code, you can build any app you want! |
...
Find the latest release, click on it, and download the attached files (may look like this: BenOS HTML Edition _version name/number_.html
